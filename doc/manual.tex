...
\todo[inline]{Vielleicht  noch auflisten was die alles haben}
...
separate download and import scripts as described in \ref{download-and-import-noaa-gfs-data-forecasts} 
...
for Germany from Geofabrik and import them with imposm as described in \ref{import-osm-data}.
...
\subsection{Relational Schema}
  ...
  ~\\
  The relational schema is following Kemper and Eickler \cite{Kemper2011} \todo[inline]{Fix bibtex include}.
...
\todo[inline]{Bitte zeilennummern wegmachen, das sieht sehr doof aus bei command listings}
\begin{lstlisting}
...
/todo[inline]{warum ist conda raus genommen?}
...
\lstinline{source ~/miniconda3/bin/activate spatial-weather}

\ \\
Then you can run the Webserver:

\lstinline{python manage.py runserver}
